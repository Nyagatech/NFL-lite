<template>
  <div class="container mx-auto p-4">
    ...
    <SearchBar />
    <div v-if="showsStore.loading" class="text-center text-3xl bold">Loading...</div>
    ...
    <div v-else-if="showsStore.searchResults.length > 0" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <div v-for="show in showsStore.searchResults" :key="show.id" class="border rounded p-2">
